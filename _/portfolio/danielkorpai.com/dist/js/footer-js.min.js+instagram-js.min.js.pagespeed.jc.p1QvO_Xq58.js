...
var mod_pagespeed_BgOM_8Rh3m = "var token=\"569060988.18046c2.0b9962ceb1a04dcd90901709c439f39a\",num_photos=9;$.ajax({url:\"https://api.instagram.com/v1/users/self/media/recent\",dataType:\"jsonp\",type:\"GET\",data:{access_token:token,count:num_photos},success:function(a){for(x in console.log(a),a.data)$(\".instagram-feed\").append('<li class=\"instagram-img-container img-container\"><a href=\"'+a.data[x].link+'\" target=\"_blank\"><img src=\"'+a.data[x].images.standard_resolution.url+'\"></a></li>')},error:function(a){console.log(a)}});";
